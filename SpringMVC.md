...
1. ![image-20220629110308925](image-20220629110308925.png)
...
<h3>
  <a href="${ctx}/books/selectAll">点击进入列表页</a>
</h3>
</body>
</html>
...
<script src="${ctx}/js/jquery.js"></script>
<script>
    function deleteById(bookID,dom){
        $.getJSON("${ctx}/books/deleteById2/"+bookID,{},function(data){
            if(data.info=="yes"){
              alert("删除成功!");
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-4 column">
      <a class="btn btn-primary" href="${ctx}/books/toAdd">新增</a>
    </div>
  </div>
      ...
      <table class="table table-hover table-striped">
        ...
        <c:forEach var="book" items="${booksList}">
          <tr>
            ...
            <td>${book.detail}</td>
            <td>
              <a href="${ctx}/books/toUpdate?bookID=${book.bookID}">更改</a> |
              <a href="javascript:void(0)" onclick="deleteById(${book.bookID},this);">删除</a>
            </td>
          </tr>
        </c:forEach>
        </tbody>
...
<div class="container">
  ...
  <form action="${ctx}/books/addBook" method="post">
...
public class BooksController {
    ...
    public String selectBookById(@RequestParam("bookID") int bookID, Model model){
        ...
        Books books =  booksService.selectBooks(maps).get(0);
    ...
    public String updateBook(Books books){
        int num=  booksService.updateBook(books);
        return "redirect:/books/selectAll";
    }
}
...
<div class="container">
  ...
  <form action="${ctx}/books/updateBooks" method="post">
...
public class BooksController {
    ...
    public String deleteBookById(@PathVariable("bookID") int bookID){
        int num =  booksService.deleteBookById(bookID);
        return "forward:/books/selectAll";
    }
    @RequestMapping("/deleteById2/{bookID}")
    @ResponseBody
    public String deleteBookById2(@PathVariable("bookID") int bookID){
        int num =  booksService.deleteBookById(bookID);
        if(num>0){
            return "{\"info\":\"yes\"}";
        }else{
...
![image-20220704161001837](image-20220704161001837.png)

![image-20220704161016627](image-20220704161016627.png)
...
<h3>
  <a href="${ctx}/inter/doLogin">登录</a>
  <a href="${ctx}/inter/success">进入成功页面</a>
</h3>
</body>
</html>
...
public class InterDemoController {
    ...
    public String test2(HttpSession session,String username,String pwd){
        System.out.println("username:"+username);
        session.setAttribute("username",username);
        return "redirect:/interDemo/success.jsp";
    }
    @RequestMapping("/doLogin")
    public String test3(){
        return "redirect:/interDemo/login.jsp";
    }
    ...
    public String test5(HttpSession session){
        ...
        return "redirect:/interDemo/index.jsp";
    }
}
...
<body>
   ${username}    这是成功页面
    <a href="${pageContext.request.contextPath}/inter/logout">注销用户</a>
</body>
</html>
```
...
@RequestMapping(value="/download/{fileName:.+}")
    public String downloads(@PathVariable("fileName") String fileName, HttpServletResponse response , HttpServletRequest request) throws Exception{
        //要下载的图片地址
...
```html
<body>
  <img src="${ctx}/files/xb106.jpg" width="310px" height="470px"><a href="${ctx}/download/xb106.jpg">下载 </a>
  <img src="${ctx}/files/xb098.jpg" width="310px" height="470px"><a href="${ctx}/download/xb098.jpg">下载 </a>
</body>
```
